            ...
            <form class="row g-0" @submit.prevent="updatePhoto" enctype="multipart/form-data">
                <div class="col-md-4">
                    <div class="d-flex align-items-center justify-content-center position-relative h-100"
                        ...
                        <img ref="image" class="img-fluid rounded-start w-100 h-100" alt="..." style="object-fit: cover;"
                            :src="photos_url + photo.photos.name_image">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                            ...
                            <select class="js-example-basic-multiple" name="states[]" multiple="multiple" id="categories">
                                <template v-for="category in categories" :key="category.id">
                                    <option :value="category.id"
                                        :selected="data_post.categories_id.includes(category.id.toString())">{{
