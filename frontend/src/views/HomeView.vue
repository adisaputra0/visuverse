      ...
      <div class="container my-5 mb-md-6">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6 text-center">
            <h2 class="mb-4 display-5"><img alt="Vue logo" src="../assets/logo.png" width="50"> Visuverse</h2>
            <p class="text-secondary mb-4 mb-md-5">Discover Boundless Beauty: Where Every Image Tells a Story in Your
              Visual Universe!</p>
  ...
  methods: {
    async fetchDataCategories() {
      try {
        ...
        this.categories = this.categories.slice(0, this.limit_category);
      } catch (error) {
